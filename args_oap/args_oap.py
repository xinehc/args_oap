...
def parse_options(argv):
    ...
    optional_one.add_argument('-v', help='the identity cutoff for diamond to search the USCMGs default 45', default=45)
    optional_one.add_argument('-w', help='the query cover cutoff for diamond to search the USCMGs default 0', default=0)
